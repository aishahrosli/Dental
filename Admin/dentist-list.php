 <?php
 require "auth.php"; 
 $query=mysqli_query($db, "SELECT * FROM dentist");
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="dentist-list.php" class="nav-link active">
                  <i class="fas fa-caret-right nav-icon"></i>
                  <p>View Dentist</p>
                </a>
              </li>
        ...
        <div class="row">
          <div class="col-12">
            ...
            ?>
                  <tr>
                    <td><?php echo ++$no;?></td>
                    <td>Dr. <?php echo ucwords($data['dr_name'])?></td>
                    <td><?php echo $data['IC']?></td>   
                    <td><?php echo $data['phoneNo']?></td>
                    <td><?php echo $data['email']?></td>          
                    <?php  echo '<td>&nbsp&nbsp 
          <a href="dentist-edit.php?id='.$data['dentist_ID'].'"> 
           <li class= "btn badge-primary"> Edit </li></a> &nbsp&nbsp

          <a href="dentist-delete.php?id='.$data['dentist_ID'].'" onclick="return confirm(\'Confirm to delete?\')"> 
          <li class= "btn badge-danger"> Delete </li></a></td>';  
        echo '</tr>';?>
                  </tr>
