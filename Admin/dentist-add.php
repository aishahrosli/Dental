        ...
        <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Dentist</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="dentist-add.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="treatment">Dentist</label>
                    <input type="text" class="form-control" name="dr_name" id="treatment_name" placeholder="Enter dentist name" required="">
                  </div>
                  <div class="form-group">
                    <label for="IC">IC Number</label>
                    <input type="text" class="form-control" name="IC" id="IC" placeholder="Enter IC Number" required="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="address" id="address" placeholder="Enter home address" required="">
                  </div>
...
<script src="../src/plugins/fullcalendar/main.js"></script>
  ...
  $sql = mysqli_query($db, "INSERT INTO dentist (dr_name, IC, phoneNo, email, address)
            VALUES ('$dr_name', '$IC', '$phoneNo', '$email', '$address')");
            
  if($sql){
      echo '<script language="javascript">';
      echo 'alert("New dentist successfully added.");';
      echo 'window.location.href="dentist-list.php";';
      echo '</script>'; 
      }else {
      
      echo '<script language="javascript">';
      echo 'alert("Fail to add dentist.");';
      echo 'window.location.href="dentist-add.php";';
      echo '</script>'; 
