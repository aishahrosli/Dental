<?php
 ...
 require "auth.php";
  ...
  $query = mysqli_query($db,"SELECT * FROM dentist WHERE dentist_ID='$id'");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dentist</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Dentist</a></li>
              <li class="breadcrumb-item active">Edit Dentist</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form action="#" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="dr_name" id="dr_name"  value="<?php echo $data['dr_name']; ?> "required>
                  </div>
                  <div class="form-group">
                    <label for="fees">IC Number</label>
                    <input type="text" class="form-control" name="IC" id="IC" value="<?php echo  $data['IC']; ?>"required >
                  </div>
                  <div class="form-group">
                    <label for="fees">Phone Number</label>
                    <input type="text" class="form-control" name="phoneNo" id="phoneNo" value="<?php echo  $data['phoneNo']; ?>"required >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="fees">Home Address</label>
...
<script src="../src/plugins/fullcalendar/main.js"></script>
  ...
  $address = $_POST['address'];
   ...
   $sql = mysqli_query($db,"UPDATE dentist SET dr_name='$dr_name', IC='$IC', phoneNo = '$phoneNo', email='$email', address='$address' WHERE dentist_ID='$id'") or die(mysqli_error());
            
   if($sql == TRUE) 
    {
    echo '<script language = "javascript">';
    echo 'alert("Dentist Information Update Successfully");';
    echo 'window.location.href ="dentist-list.php";';
    echo '</script>'; 
    }
    else {  
